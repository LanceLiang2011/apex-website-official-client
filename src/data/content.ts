...
export const content = {
  ...
  home: {
    ...
    about: {
      ...
      subtitle: {
        zh: "专注教育，成就未来",
        en: "Focus on Education, Achieve the Future",
      },
      description: {
  ...
  pages: {
    ...
    course: {
      ...
      targetAudienceItems: [
        {
          zh: "希望提升学术成绩的学生",
          en: "Students wishing to improve academic grades",
        },
        {
          zh: "准备参加标化考试的学生",
          en: "Students preparing for standardized tests",
        },
        {
          zh: "有志于申请名校的学生",
          en: "Students aiming for top universities",
        },
        {
          zh: "需要系统性规划的学生",
          en: "Students needing systematic planning",
        },
      ],
    },
  },
    ...
    steps: [
      {
        ...
        description: {
          zh: "掌握学生信息，了解留学意向",
          en: "Assess student background & goals",
        },
        icon: "chat",
      },
      {
        ...
        description: {
          zh: "院校专业分析，确定申请目标",
          en: "Analyze options & set targets",
        },
        icon: "document",
      },
      {
        ...
        description: {
          zh: "收集、整理、翻译申请材料",
          en: "Collect & translate documents",
        },
        icon: "folder",
      },
      {
        ...
        description: {
          zh: "GPA、语言能力、背景提升建议",
          en: "GPA, Language & Background advice",
        },
        icon: "bulb",
      },
      {
